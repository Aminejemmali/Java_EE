<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.jsp"><img alt="logo" style=" margin-left: 20px; " src="./includes/images/logo5.png" width="230" height="180"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mx-auto p-4">
        <li class="nav-item" style=" margin-left: 80px; ">
          <a class="nav-link active" aria-current="page" style="font-weight: bold ; font-size: 30px;" href="index.jsp">Home</a>
        </li>
        <li class="nav-item" style=" margin-left:  80px; " >
          <a class="nav-link" href="cart.jsp" style="font-weight: bold ; font-size: 30px;">Cart <span class="badge badge-danger px-0 " style="color:red;">${cart_list.size()}</span></a>
				...
				%>
				 <li class="nav-item" style=" margin-left:  80px; ">
          <a class="nav-link " style="font-weight: bold ; font-size: 30px;" href="orders.jsp">Orders</a>
        </li>
